...
// degrees -> radians
// static inline constexpr float _radians(float deg)
// {
//     return deg * DEG_TO_RAD;
// }

// // radians -> degrees
// static inline constexpr float _degrees(float rad)
// // {
...
// float sq_(const T first, const Params... parameters)
// {
...
// {
//     return sqrtf(sq_(first, second, parameters...));
// }

template<typename T, typename U>
float norm2(const T first, const U second)
{
    T a=first*first;
    U b=second*second;
    return sqrtf(a+b);
...
float norm3(const T first, const U second, const V third)
{
    T a=first*first;
    U b=second*second;
    V c=third*third;
